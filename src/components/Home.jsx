...
export default function Home() {
  ...
  const [cards] = useState(() => {
    ...
    let idx2;
    do {
      idx2 = Math.floor(Math.random() * category.length);
    } while (idx2 === idx1);
      ...
      tl.to(".preloader_grid .item", {
        ...
        .add(() => {
          if (!homeSound.current) {
            homeSound.current = new Audio(
              `${import.meta.env.BASE_URL}sounds/home2.mp3`,
            );
  ...
  useEffect(() => {
    if (!isLoading) {
      ...
      const tl = gsap.timeline({
        defaults: { ease: "expoScale(0.5,7,none)", duration: 1 },
      });
      ...
      tl.fromTo(
        ...
        .to(
          [leftCrackRef.current, rightCrackRef.current],
          { opacity: 1, duration: 0.06, ease: "none" },
          "<",
        )
        .to(
          ".home",
          { x: 10, duration: 0.04, yoyo: true, repeat: 7, ease: "none" },
          "<",
        )
        .to(impactRef.current, {
          opacity: 0,
        ...
        .to(
          crackRef.current,
          { opacity: 0, scale: 1.3, duration: 0.55, ease: "power2.out" },
          "<",
        )
        ...
        .to(
          leftCardRef.current,
          { x: -10, rotation: 12, duration: 0.3, ease: "back.out(2)" },
          "-=0.35",
        )
        .to(
          rightCardRef.current,
        ...
        .add(() => {
          gsap
            ...
            .add(() => {
              ...
              spotlightRef.current.style.animation =
                "spotlight_flicker 4s linear infinite";
            });
        }, "-=0.1")
    ...
    <section className="home_container">
      ...
      <div className="home">
        <h1 className="title_container">
          <span ref={lastRef} className="word last">
            last
          </span>
          ...
          <span ref={championRef} className="word champion">
            champion
          </span>
        </h1>
        ...
        <div className="home_media">
          <a className="social-link" href="khadidja-dev.fr" target="_blank">
            <FaCode size={12} />
          </a>
          <a
            className="social-link"
            href="https://www.linkedin.com/in/khadidja-ait-si-ali/"
            target="_blank"
          >
          ...
          <a
            className="social-link"
            href="mailto:khadidja.aitsiali@gmail.com"
            target="_blank"
          >
            <IoMail size={12} />
          </a>
